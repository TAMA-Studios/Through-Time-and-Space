...
public class FileHelper {
	...
	public static boolean createStoredFile(String path, String fileName, String content) {
	...
	public static boolean createStoredFile(Path path, String fileName, String content) {
