 ...
 * data/modid/triggerapi/gui/*.json Scripts:
 * data/modid/triggerapi/gui/scripts/*.lua
 */
public class GuiLoader extends SimpleJsonResourceReloadListener {
	...
	@Override
	protected void apply(Map<ResourceLocation, com.google.gson.JsonElement> map, ResourceManager resourceManager,
		...
		LOGGER.info("Loaded {} GUI definitions and {} Lua scripts", GUI_DEFINITIONS.size(), LUA_SCRIPTS.size());
	}
