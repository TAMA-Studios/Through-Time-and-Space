...
public class UtilityGL11Debug {
  ...
  public GLproperty[] propertyList = {
    new GLproperty(
        GL11.GL_CURRENT_COLOR, "GL_CURRENT_COLOR", "Current color", "current", "glGetFloatv()"),
    new GLproperty(
    ...
    new GLproperty(
        ...
        "glGetFloatv()"),
    new GLproperty(
        GL11.GL_CURRENT_NORMAL, "GL_CURRENT_NORMAL", "Current normal", "current", "glGetFloatv()"),
    new GLproperty(
    ...
    new GLproperty(
        GL11.GL_FOG_DENSITY, "GL_FOG_DENSITY", "Exponential fog density", "fog", "glGetFloatv()"),
    ...
    new GLproperty(
        ...
        "glGetIntegerv()"),
    new GLproperty(
        GL11.GL_AMBIENT, "GL_AMBIENT", "Ambient material color", "lighting", "glGetMaterialfv()"),
    new GLproperty(
        GL11.GL_DIFFUSE, "GL_DIFFUSE", "Diffuse material color", "lighting", "glGetMaterialfv()"),
    new GLproperty(
        GL11.GL_SPECULAR,
        "GL_SPECULAR",
    ...
    new GLproperty(
        ...
        "glGetLightfv()"),
    new GLproperty(
        GL11.GL_POSITION, "GL_POSITION", "Position of light i", "lighting", "glGetLightfv()"),
    new GLproperty(
    ...
    new GLproperty(
        ...
        "glGetLightfv()"),
    new GLproperty(
        GL11.GL_LIGHT0, "GL_LIGHT0", "True if light 0 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_LIGHT1, "GL_LIGHT1", "True if light 1 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_LIGHT2, "GL_LIGHT2", "True if light 2 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_LIGHT3, "GL_LIGHT3", "True if light 3 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_LIGHT4, "GL_LIGHT4", "True if light 4 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_LIGHT5, "GL_LIGHT5", "True if light 5 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_LIGHT6, "GL_LIGHT6", "True if light 6 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_LIGHT7, "GL_LIGHT7", "True if light 7 enabled", "lighting/enable", "glIsEnabled()"),
    new GLproperty(
    ...
    new GLproperty(
        ...
        "glIsEnabled()"),
    new GLproperty(
        GL11.GL_SCISSOR_BOX, "GL_SCISSOR_BOX", "Scissor box", "scissor", "glGetIntegerv()"),
    new GLproperty(
        GL11.GL_ALPHA_TEST,
        "GL_ALPHA_TEST",
        "Alpha test enabled",
    ...
    new GLproperty(
        ...
        "glGetIntegerv()"),
    new GLproperty(
        GL11.GL_BLEND, "GL_BLEND", "Blending enabled", "color-buffer/enable", "glIsEnabled()"),
    new GLproperty(
        GL11.GL_BLEND_SRC,
        "GL_BLEND_SRC",
    ...
    new GLproperty(
        ...
        "glGetIntegerv()"),
    new GLproperty(
        GL11.GL_DITHER, "GL_DITHER", "Dithering enabled", "color-buffer/enable", "glIsEnabled()"),
    new GLproperty(
    ...
    new GLproperty(
        ...
        "glGetIntegerv()"),
    new GLproperty(
        GL11.GL_MAP_COLOR, "GL_MAP_COLOR", "True if colors are mapped", "pixel", "glGetBooleanv()"),
    new GLproperty(
        GL11.GL_MAP_STENCIL,
        "GL_MAP_STENCIL",
    ...
    new GLproperty(
        GL11.GL_READ_BUFFER, "GL_READ_BUFFER", "Read source buffer", "pixel", "glGetIntegerv()"),
    ...
    new GLproperty(
        GL11.GL_DOMAIN, "GL_DOMAIN", "1D domain endpoints", "capability", "glGetMapfv()"),
    new GLproperty(
        GL11.GL_DOMAIN, "GL_DOMAIN", "2D domain endpoints", "capability", "glGetMapfv()"),
    new GLproperty(
    ...
    new GLproperty(
        ...
        "glGetIntegerv()"),
    new GLproperty(
        GL11.GL_LIST_BASE, "GL_LIST_BASE", "Setting of glListBase()", "list", "glGetIntegerv()"),
    new GLproperty(
        GL11.GL_LIST_INDEX,
        "GL_LIST_INDEX",
