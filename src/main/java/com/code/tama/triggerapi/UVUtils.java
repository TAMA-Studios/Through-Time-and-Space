...
public class UVUtils {
     ...
     * @param pix the pixel coordinate
     * @param imgSize the size of the image on the same axis as <code>pix</code>. if <code>pix</code> is on the X axis, pass the images X size.
