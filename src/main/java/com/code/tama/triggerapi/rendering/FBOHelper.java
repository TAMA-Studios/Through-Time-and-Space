...
public class FBOHelper {
  ...
  public static final ResourceLocation BLACK =
      new ResourceLocation(
          TTSMod.MODID,
          "textures/black.png"); // TODO: set RGB values when rendering this for sky color
  ...
  public static class StencilBufferStorage extends RenderBuffers {
    ...
    public static RenderType getRenderType() {
      RenderType.CompositeState parameters =
    ...
    private static void put(
        Object2ObjectLinkedOpenHashMap<RenderType, BufferBuilder> builderStorage,
        RenderType layer) {
