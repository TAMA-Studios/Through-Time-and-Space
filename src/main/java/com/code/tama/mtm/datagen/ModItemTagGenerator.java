...
//                .add(MItems.BAR_BRAWL_MUSIC_DISC.get());
        ...
        this.tag(ItemTags.LOGS_THAT_BURN)
                .add(MTMBlocks.GALLIFREYAN_OAK_LOG.get().asItem())
                .add(MTMBlocks.GALLIFREYAN_OAK_WOOD.get().asItem())
                .add(MTMBlocks.STRIPPED_GALLIFREYAN_OAK_LOG.get().asItem())
                .add(MTMBlocks.STRIPPED_GALLIFREYAN_OAK_WOOD.get().asItem());

        this.tag(ItemTags.PLANKS)
                .add(MTMBlocks.GALLIFREYAN_OAK_PLANKS.get().asItem());
    }
}