...
import com.code.tama.mtm.Client.Renderer.World.AbstractLevelRenderer;
import com.code.tama.mtm.Client.Renderer.World.GallifreySkyRenderer;
import com.code.tama.mtm.Client.Renderer.World.TardisSkyRenderer;
...
public class CustomLevelRenderer {
    ...
    public static void onRenderLevel(RenderLevelStageEvent event) {
        mtm.skyboxRenderThread.SetEvent(event);
        mtm.skyboxRenderThread.run();
