...
public class ExteriorDataLoader implements ResourceManagerReloadListener {
    ...
    public void onResourceManagerReload(ResourceManager resourceManager) {
        ...
        for (String namespace : resourceManager.getNamespaces()) {
            ...
            Map<ResourceLocation, Resource> resources = resourceManager.listResources("exterior", fileName -> fileName.toString().endsWith(".json"));
                ...
                try (InputStreamReader reader = new InputStreamReader(resource.open())) {
                    ...
                    if (jsonElement.isJsonObject()) {
                        ...
                        if (isValidJson(jsonObject)) {
                            ...
                            DataExterior dataExterior = new DataExterior(name, textureLocation);
