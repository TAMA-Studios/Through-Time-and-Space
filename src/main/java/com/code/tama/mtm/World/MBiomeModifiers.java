...
//        context.register(ADD_ZEITON_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
...
//                GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(ADD_NETHER_ZEITON_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_NETHER),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.NETHER_ZEITON_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(ADD_END_ZEITON_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_END),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.END_ZEITON_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(ADD_TREE_GALLIFREYAN_OAK, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
