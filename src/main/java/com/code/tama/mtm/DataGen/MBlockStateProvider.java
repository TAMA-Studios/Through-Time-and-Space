...
public class MBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        blockWithItem(MBlocks.ZEITON_BLOCK);
        blockWithItem(MBlocks.RAW_ZEITON_BLOCK);

        blockWithItem(MBlocks.AMETHYST_ROTOR);
        blockWithItem(MBlocks.COPPER_ROTOR);
        blockWithItem(MBlocks.BLUE_ROTOR);

        blockWithItem(MBlocks.ZEITON_ORE);
        blockWithItem(MBlocks.DEEPSLATE_ZEITON_ORE);
        blockWithItem(MBlocks.END_STONE_ZEITON_ORE);
        blockWithItem(MBlocks.NETHER_ZEITON_ORE);

        stairsBlock(((StairBlock) MBlocks.GALLIFREYAN_OAK_STAIRS.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()));
        slabBlock(((SlabBlock) MBlocks.GALLIFREYAN_OAK_SLAB.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()));

        buttonBlock(((ButtonBlock) MBlocks.GALLIFREYAN_OAK_BUTTON.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()));
        pressurePlateBlock(((PressurePlateBlock) MBlocks.GALLIFREYAN_OAK_PRESSURE_PLATE.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()));

        fenceBlock(((FenceBlock) MBlocks.GALLIFREYAN_OAK_FENCE.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()));
        fenceGateBlock(((FenceGateBlock) MBlocks.GALLIFREYAN_OAK_FENCE_GATE.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()));
        wallBlock(((WallBlock) MBlocks.GALLIFREYAN_OAK_WALL.get()), blockTexture(MBlocks.ZEITON_BLOCK.get()));

        doorBlockWithRenderType(((DoorBlock) MBlocks.GALLIFREYAN_OAK_DOOR.get()), modLoc("block/dimensional/gallifreyan/gallifreyan_oak_door_bottom"), modLoc("block/dimensional/gallifreyan/gallifreyan_oak_door_top"), "cutout");
        trapdoorBlockWithRenderType(((TrapDoorBlock) MBlocks.GALLIFREYAN_OAK_TRAPDOOR.get()), modLoc("block/dimensional/gallifreyan/gallifreyan_oak_trapdoor"), true, "cutout");
...
//                new ModelFile.UncheckedModelFile(modLoc("block/gem_polishing_station")));
        ...
        logBlock(((RotatedPillarBlock) MBlocks.GALLIFREYAN_OAK_LOG.get()));
        axisBlock(((RotatedPillarBlock) MBlocks.GALLIFREYAN_OAK_WOOD.get()), blockTexture(MBlocks.GALLIFREYAN_OAK_LOG.get()), blockTexture(MBlocks.GALLIFREYAN_OAK_LOG.get()));

        axisBlock(((RotatedPillarBlock) MBlocks.STRIPPED_GALLIFREYAN_OAK_LOG.get()), blockTexture(MBlocks.STRIPPED_GALLIFREYAN_OAK_LOG.get()),
                new ResourceLocation(MODID, "block/stripped_gallifreyan_oak_log_top"));

        axisBlock(((RotatedPillarBlock) MBlocks.STRIPPED_GALLIFREYAN_OAK_WOOD.get()), blockTexture(MBlocks.STRIPPED_GALLIFREYAN_OAK_LOG.get()),
                blockTexture(MBlocks.STRIPPED_GALLIFREYAN_OAK_LOG.get()));

        blockWithItem(MBlocks.GALLIFREYAN_OAK_LOG);
        blockWithItem(MBlocks.GALLIFREYAN_OAK_WOOD);
        blockWithItem(MBlocks.STRIPPED_GALLIFREYAN_OAK_LOG);
        blockWithItem(MBlocks.STRIPPED_GALLIFREYAN_OAK_WOOD);
        blockWithItem(MBlocks.GALLIFREYAN_SAND);
        blockWithItem(MBlocks.GALLIFREYAN_OAK_PLANKS);
        SpecialBlockItem(MBlocks.HUDOLIN_CONSOLE_BLOCK);
        leavesBlock(MBlocks.GALLIFREYAN_OAK_LEAVES);
...
//        hangingSignBlock(MBlocks.PINE_HANGING_SIGN.get(), MBlocks.PINE_WALL_HANGING_SIGN.get(), blockTexture(MBlocks.PINE_PLANKS.get()));
        saplingBlock(MBlocks.GALLIFREYAN_SAPLING);
