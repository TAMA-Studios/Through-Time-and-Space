...
//        saplingItem(MBlocks.PINE_SAPLING);
        withExistingParent(MItems.CONSOLE_TILE.getId().getPath(), mcLoc("block/air"));
        withExistingParent(MItems.SMITH_EXTERIOR.getId().getPath(), mcLoc("block/air"));
        withExistingParent(MBlocks.HUDOLIN_CONSOLE_BLOCK.getId().getPath(), mcLoc("block/air"));
        saplingItem(MBlocks.GALLIFREYAN_SAPLING);
        withExistingParent(MBlocks.GALLIFREYAN_OAK_LOG.getId().getPath(), new ResourceLocation(MODID, "dimensional/gallifreyan/gallifreyan_oak_log"));
        simpleBlockItemBlockTexture(MBlocks.GALLIFREYAN_OAK_LOG);
        simpleBlockItemBlockTexture(MBlocks.GALLIFREYAN_OAK_LEAVES);
        simpleBlockItemBlockTexture(MBlocks.GALLIFREYAN_OAK_PLANKS);
        simpleBlockItemBlockTexture(MBlocks.STRIPPED_GALLIFREYAN_OAK_WOOD);
        simpleBlockItemBlockTexture(MBlocks.STRIPPED_GALLIFREYAN_OAK_LOG);
        simpleBlockItemBlockTexture(MBlocks.STRIPPED_GALLIFREYAN_OAK_WOOD);
        simpleBlockItemBlockTexture(MBlocks.GALLIFREYAN_SAND);
    }
