...
import static com.code.tama.mtm.Items.MItems.*;
...
public class MTabs {
    ...
    public static final RegistryObject<CreativeModeTab> DIMENSIONAL_TAB = CREATIVE_MODE_TABS.register("dimensional_tab", () -> CreativeModeTab.builder().withTabsBefore(MTabs.MAIN_TAB.getId()).icon(() ->
            SMITH_EXTERIOR.get().getDefaultInstance()).displayItems((parameters, output) ->
