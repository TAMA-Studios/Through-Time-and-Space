...
public class MDimensions {
    ...
    public static void bootstrapType(BootstapContext<DimensionType> context) {
        context.register(GALLIFREY_DIM_TYPE, new DimensionType(
        ...
        context.register(VAROS_DIM_TYPE, new DimensionType(
                OptionalLong.empty(), // fixedTime
                false, // hasSkylight
                false, // hasCeiling
                false, // ultraWarm
        ...
        NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
                MultiNoiseBiomeSource.createFromList(
                        new Climate.ParameterList<>(List.of(Pair.of(
                                        Climate.parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(MBiomes.GALLIFREYAN_PLAINS)),
                                Pair.of(
                                        Climate.parameters(0.1F, 0.2F, 0.0F, 0.2F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(MBiomes.GALLIFREYAN_DESERT))
                        ))),
                noiseGenSettings.getOrThrow(NoiseGeneratorSettings.OVERWORLD));
