...
public class SpaceTimeCoordinate implements INBTSerializable<CompoundTag> {
  public static Codec<SpaceTimeCoordinate> CODEC =
              ...
              instance
                  .group(
                      ...
                      Level.RESOURCE_KEY_CODEC
                          .fieldOf("level")
                          .forGetter(SpaceTimeCoordinate::getLevelKey))
  ...
  public void deserializeNBT(CompoundTag nbt) {
    ...
    this.level =
        ResourceKey.create(Registries.DIMENSION, ResourceLocation.parse(nbt.getString("levelLoc")));
  }
  ...
  public CompoundTag serializeNBT() {
    ...
    tag.putString(
        "levelLoc", this.level.location().getNamespace() + ":" + this.level.location().getPath());
    return tag;
  }
