...
public class MConfiguredFeatures {
  public static final ResourceKey<ConfiguredFeature<?, ?>> END_ZEITON_ORE_KEY =
      registerKey("end_zeiton_ore");
  public static final ResourceKey<ConfiguredFeature<?, ?>> GALLIFREYAN_OAK_KEY =
      registerKey("gallifreyan_oak");
  public static final ResourceKey<ConfiguredFeature<?, ?>> NETHER_ZEITON_ORE_KEY =
      registerKey("nether_zeiton_ore");

  public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_ZEITON_ORE_KEY =
      registerKey("zeiton_ore");
  ...
  public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
    ...
    List<OreConfiguration.TargetBlockState> overworldSapphireOres =
        List.of(
            ...
            OreConfiguration.target(
                deepslateReplaceables, TTSBlocks.DEEPSLATE_ZEITON_ORE.get().defaultBlockState()));

    register(
        context,
        OVERWORLD_ZEITON_ORE_KEY,
        Feature.ORE,
