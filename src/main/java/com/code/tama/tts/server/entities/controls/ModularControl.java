...
public class ModularControl extends AbstractControlEntity implements IEntityAdditionalSpawnData {
  ...
  public void OnControlClicked(ITARDISLevel capability, Player player) {
    ...
    InteractionResult interactionResult =
        this.GetControl().GetControl().OnRightClick(capability, player);
  ...
  public Component TranslationKey() {
    MutableComponent component =
        Component.translatable("tts.tardis.control." + this.GetControl().name().toLowerCase());
  ...
  protected void readAdditionalSaveData(@NotNull CompoundTag Tag) {
    ...
    this.Position =
        new Vec3(Tag.getDouble("pos_x"), Tag.getDouble("pos_y"), Tag.getDouble("pos_z"));
        ...
        this.consoleTile =
            (AbstractConsoleTile)
                this.level()
                    ...
                    .getBlockEntity(
                        new BlockPos(
                            Tag.getInt("console_x"),
                            Tag.getInt("console_y"),
