...
public abstract class AbstractSubsystemBlock extends Block {
  @Getter private AbstractSubsystem subsystem;
   ...
   *
   * @param blockPos The position of the subsystem block being integrated, used for verifying that
   *     it in indeed a valid multiblock structure
   */
