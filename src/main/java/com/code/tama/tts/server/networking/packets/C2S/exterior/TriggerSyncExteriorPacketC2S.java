...
public class TriggerSyncExteriorPacketC2S {
	...
	public static void handle(TriggerSyncExteriorPacketC2S packet,
		...
		context.enqueueWork(() -> {
			...
			if (be instanceof ExteriorTile exteriorTile) {
				Networking.sendPacketToDimension(packet.level,
						new SyncExteriorPacketS2C(exteriorTile.getModelIndex(), exteriorTile.state, exteriorTile.isArtificial,
