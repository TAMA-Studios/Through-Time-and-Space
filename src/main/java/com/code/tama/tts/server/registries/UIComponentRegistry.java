...
public class UIComponentRegistry {
  ...
  public static final RegistryObject<UIComponent> LIGHT_DOWN =
      UI_COMPONENTS.register(
          "light_down",
          () ->
              new UIComponentLightDown(
                  new Float[] {1f, 2f}, new Float[] {9f, 10f}, ComponentTypes.BUTTON));

  public static final RegistryObject<UIComponent> LIGHT_UP =
      UI_COMPONENTS.register(
          "light_up",
          () ->
              new UIComponentLightUp(
                  new Float[] {1f, 2f}, new Float[] {7f, 8f}, ComponentTypes.BUTTON));

  public static final RegistryObject<UIComponent> NEXT =
      UI_COMPONENTS.register(
          "next",
          () ->
              new UIComponentNext(
                  new Float[] {14f, 15f}, new Float[] {14f, 15f}, ComponentTypes.BUTTON));

  public static final RegistryObject<UIComponent> POWER =
      UI_COMPONENTS.register(
          "power",
          () ->
              new UIComponentPower(
                  new Float[] {14.5f, 15.5f}, new Float[] {0.5f, 1.5f}, ComponentTypes.BUTTON));
  public static final RegistryObject<UIComponent> PREVIOUS =
      UI_COMPONENTS.register(
          "previous",
          () ->
              new UIComponentPrevious(
                  new Float[] {1f, 2f}, new Float[] {14f, 15f}, ComponentTypes.BUTTON));
  public static final RegistryObject<UIComponent> X_COORD =
      UI_COMPONENTS.register(
          "x_coord",
          () ->
              new UIComponentXCoord(
                  new Float[] {1f, 2f}, new Float[] {7f, 8f}, ComponentTypes.BUTTON));
  public static final RegistryObject<UIComponent> Y_COORD =
      UI_COMPONENTS.register(
          "y_coord",
          () ->
              new UIComponentYCoord(
                  new Float[] {5f, 6f}, new Float[] {7f, 8f}, ComponentTypes.BUTTON));
  public static final RegistryObject<UIComponent> Z_COORD =
      UI_COMPONENTS.register(
          "z_coord",
          () ->
              new UIComponentZCoord(
                  new Float[] {9f, 10f}, new Float[] {7f, 8f}, ComponentTypes.BUTTON));
