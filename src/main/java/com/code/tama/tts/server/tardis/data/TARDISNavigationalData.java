...
public class TARDISNavigationalData {
    public static final Codec<TARDISNavigationalData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                    Codec.INT.fieldOf("increment").forGetter(TARDISNavigationalData::getIncrement),
