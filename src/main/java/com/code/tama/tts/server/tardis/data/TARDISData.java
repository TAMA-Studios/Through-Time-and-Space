...
public class TARDISData {
  public static final Codec<TARDISData> CODEC =
          ...
          instance ->
              instance
                  .group(
                      ...
                      Exterior.CODEC
                          .optionalFieldOf("exteriorModelID", Exteriors.Get(0))
                      ...
                      DoorData.CODEC
                          .fieldOf("interiorDoorData")
                          .forGetter(TARDISData::getInteriorDoorData),
                      SubsystemsData.CODEC
                          .fieldOf("subsystemsData")
                          .forGetter(TARDISData::getSubSystemsData),
                      ControlParameters.CODEC
                          .fieldOf("controlData")
                          .forGetter(TARDISData::getControlData),
                      ProtocolData.CODEC
                          .fieldOf("protocolData")
                          .forGetter(TARDISData::getProtocolsData),
                      Codec.LONG.fieldOf("ticks").forGetter(TARDISData::getTicks),
                      SpaceTimeCoordinate.CODEC
                          .fieldOf("doorBlock")
                          .forGetter(TARDISData::getDoorBlock),
  ...
  public TARDISData(
    ...
    this.ticks = ticks;
    if(vortex.equals(new ResourceLocation("", ""))) this.Vortex = new ResourceLocation(TTSMod.MODID, "textures/rift/infiniteabyssofnothingness.png");
  ...
  public void SetExteriorVariant(Exterior model) {
  ...
  public void CycleVariant() {
    this.ExteriorModel = Exteriors.Cycle(this.ExteriorModel);
  }
