...
public class GrammarNazi {
  ...
  /**
   * Replaces Underscore characters ('_') with space characters (' ') and capitalizes the first
  ...
  /**
   * Made to accept Item#toString(), remove the minecraft:item@modid, and capitalize every first
   * letter of every word while also replacing underscores with spaces
   *
   * @param text Item#toString()
   * @return Item#toString() without minecraft:item@modid and every first letter of every word
   *     capitalized
   */
