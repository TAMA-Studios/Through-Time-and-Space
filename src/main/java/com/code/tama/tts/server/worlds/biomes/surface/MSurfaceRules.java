...
public class MSurfaceRules {
  ...
  private static final SurfaceRules.RuleSource GALLIFREY_SAND =
      makeStateRule(TTSBlocks.GALLIFREYAN_SAND.get());
  private static final SurfaceRules.RuleSource GRASS_BLOCK = makeStateRule(Blocks.GRASS_BLOCK);
  private static final SurfaceRules.RuleSource RAW_ZEITON =
      makeStateRule(TTSBlocks.RAW_ZEITON_BLOCK.get());
  ...
  public static SurfaceRules.RuleSource makeRules() {
    ...
    SurfaceRules.RuleSource grassSurface =
        SurfaceRules.sequence(
            SurfaceRules.ifTrue(
                ...
                SurfaceRules.ifTrue(
                    SurfaceRules.isBiome(MBiomes.GALLIFREYAN_PLAINS),
    ...
    return SurfaceRules.sequence(
        SurfaceRules.sequence(
            SurfaceRules.ifTrue(
                SurfaceRules.isBiome(MBiomes.GALLIFREYAN_DESERT),
                SurfaceRules.ifTrue(
                    SurfaceRules.ON_FLOOR,
                    SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(), GALLIFREY_SAND))),
