...
public enum FlightTerminationProtocolEnum {
	EMERGENCY_STOP("emergency_stop", 1.0f, 0.3f, new EmergencyStopProtocolHandler()), POLITE("polite_terminus", 0.1f,
			0.1f, 0.8f, 0.5f, new PoliteTerminusProtocolHandler(), true), QUICK_STOP("quick_stop", 0.2f, 0.7f, 0.7f,
					0.7f, new QuickStopProtocolHandler(),
					true), URGENT_STOP("urgent_stop", 0.2f, 1.0f, 1.0f, 0.9f, new UrgentStopProtocolHandler(), true);
	...
	FlightTerminationProtocolEnum(String name, float ShakeAmount, float Accuracy,
	...
	FlightTerminationProtocolEnum(String name, float TakeoffShakeAmount, float LandShakeAmount, float Accuracy,
			float Speed, TerminationProtocolHandler terminationProtocolHandler, boolean IsSelectable) {
