...
public class LandThread extends Thread {
    ...
    public void run() {
        ...
        BlockState exteriorBlockState = TTSBlocks.EXTERIOR_BLOCK.get().defaultBlockState().rotate(TARDISLevelCapability.DirectionToRotation(this.itardisLevel.GetFacing()));
