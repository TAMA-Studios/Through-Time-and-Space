...
public class MDimensions {
  ...
  public static final ResourceKey<DimensionType> GALLIFREY_DIM_TYPE =
      ResourceKey.create(Registries.DIMENSION_TYPE, new ResourceLocation(MODID, "gallifrey_type"));
  public static final ResourceKey<Level> GALLIFREY_LEVEL_KEY =
      ResourceKey.create(Registries.DIMENSION, new ResourceLocation(MODID, "gallifrey"));
  public static final ResourceKey<LevelStem> GALLIFREY_STEM =
      ResourceKey.create(Registries.LEVEL_STEM, new ResourceLocation(MODID, "gallifrey"));
  ...
  public static final ResourceKey<Level> TARDIS_LEVEL_KEY =
      ResourceKey.create(Registries.DIMENSION, new ResourceLocation(MODID, "tardis"));
  public static final ResourceKey<DimensionType> VAROS_DIM_TYPE =
      ResourceKey.create(Registries.DIMENSION_TYPE, new ResourceLocation(MODID, "varos_type"));

  public static final ResourceKey<LevelStem> VAROS_KEY =
      ResourceKey.create(Registries.LEVEL_STEM, new ResourceLocation(MODID, "varos"));
  public static final ResourceKey<Level> VAROS_LEVEL_KEY =
      ResourceKey.create(Registries.DIMENSION, new ResourceLocation(MODID, "varos"));
  ...
  public static void bootstrapStem(BootstapContext<LevelStem> context) {
    ...
    LevelStem stem =
        new LevelStem(
            dimTypes.getOrThrow(MDimensions.GALLIFREY_DIM_TYPE), noiseBasedChunkGenerator);
  ...
  public static void bootstrapType(BootstapContext<DimensionType> context) {
    ...
    context.register(
        ...
        new DimensionType(
            ...
            DimensionEffects
                .VAROS_EFFECTS, // effectsLocation // BuiltinDimensionTypes.OVERWORLD_EFFECTS,
            1.0f, // ambientLight
