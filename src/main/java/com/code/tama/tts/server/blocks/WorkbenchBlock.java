...
public class WorkbenchBlock extends Block implements EntityBlock {
  ...
  public void tickFunction(
      BlockState p_225534_1_, ServerLevel p_225534_2_, BlockPos p_225534_3_, int timer) {}
  ...
  public InteractionResult use(
    ...
    if (tile != null && tile instanceof WorkbenchTile workbenchTile) {
      ...
      if (player.getMainHandItem().getItem() instanceof SonicItem) {
        ...
        Item result =
            RecipeRegistry.GetRecipeResult(
      ...
      // If player isn't holding sonic, and the workbench isn't full, (and they're not holding a
      // nozzle) add the
