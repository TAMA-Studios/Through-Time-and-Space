...
//	}
	...
	@Override
	public <T extends Block> TTSBlockBuilder<T, TTSRegistrate> block(NonNullFunction<BlockBehaviour.Properties, T> factory) {
		return this.block(this.self(), factory);
	}

	@Override
	public <T extends Block> TTSBlockBuilder<T, TTSRegistrate> block(String name, NonNullFunction<BlockBehaviour.Properties, T> factory) {
		return this.block(this.self(), name, factory);
	}

	@Override
	public <T extends Block, P> TTSBlockBuilder<T, P> block(P parent, NonNullFunction<BlockBehaviour.Properties, T> factory) {
		return this.block(parent, this.currentName(), factory);
	}

	@Override
	public <T extends Block, P> @NotNull TTSBlockBuilder<T, P> block(@NotNull P parent, String name, NonNullFunction<BlockBehaviour.Properties, T> factory) {
		return (TTSBlockBuilder<T, P>) this.entry(name, (callback) -> TTSBlockBuilder.create(this, parent, name, callback, factory));
	}
}