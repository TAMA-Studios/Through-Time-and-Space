...
public class TardisEvent extends Event {
  ...
  /**
   * Two params, START, and END, let's use takeoff as an example, START is called before any takeoff
   * code begins, and END is called when all the takeoff code is finished. *
   */
