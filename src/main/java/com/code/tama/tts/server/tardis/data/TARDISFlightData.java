...
public class TARDISFlightData {
  public static final Codec<TARDISFlightData> CODEC =
      RecordCodecBuilder.create(
          instance ->
              instance
                  .group(
                      Codec.INT
                          .fieldOf("ticksInFlight")
                          .forGetter(TARDISFlightData::getTicksInFlight),
                      Codec.INT
                          .fieldOf("ticksTillDestination")
                          .forGetter(TARDISFlightData::getTicksTillDestination),
                      ...
                      Codec.BOOL
                          .fieldOf("shouldPlayRotorAnimation")
                          .forGetter(TARDISFlightData::isPlayRotorAnimation))
