 ...
 *
 * <p>Note: while a TARDIS is in SPATIALFLIGHT, the {@code ExteriorTile}
 * itself has been removed from the world (block + BE), so nothing actually
 * holds this value live during the flight - it's set on the tile briefly on
 ...
 * spatial flight" via {@code itardisLevel.GetExteriorTile() == null}.</p>
 */
