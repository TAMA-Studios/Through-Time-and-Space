...
public class RecipeDataLoader implements ResourceManagerReloadListener {
  ...
  private final List<DataRecipe> dataRecipes =
      new ArrayList<>(); // List to store Data recipe objects
        ...
        try (InputStreamReader reader = new InputStreamReader(resource.open())) {
          ...
          if (jsonElement.isJsonObject()) {
            ...
            if (isValidJson(jsonObject)) {
              ...
              ResourceLocation nozzle =
                  new ResourceLocation(valuesObject.get("nozzle").getAsString());
              ResourceLocation result =
                  new ResourceLocation(valuesObject.get("result").getAsString());
      ...
      if (valuesObject.has("nozzle")
        ...
        try {
          BuiltInRegistries.ITEM.get(
              ResourceLocation.parse(nozzle)); // Will throw exception if invalid
        ...
        try {
          BuiltInRegistries.ITEM.get(
              ResourceLocation.parse(result)); // Will throw exception if invalid
        } catch (IllegalArgumentException e) {
