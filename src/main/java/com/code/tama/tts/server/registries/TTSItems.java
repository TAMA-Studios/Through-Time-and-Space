...
public class TTSItems {
  ...
  public static final DeferredRegister<Item> DIMENSIONAL_ITEMS =
  ...
  static {
    ...
    NESS_CONSOLE_TILE =
        ITEMS.register(
            ...
            () ->
                new ConsoleItem<>(
                    TTSTileEntities.NESS_CONSOLE_TILE,
                    TTSBlocks.NESS_CONSOLE_BLOCK.get(),
                    new Item.Properties()));
    ...
    BASIC_CONTROL_CIRCUIT =
        ITEMS.register("basic_control_circuit", () -> new Item(new Item.Properties()));

    ADVANCED_CONTROL_CIRCUIT =
        ITEMS.register("advanced_control_circuit", () -> new Item(new Item.Properties()));
  }
}
