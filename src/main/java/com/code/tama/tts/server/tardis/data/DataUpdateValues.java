...
/** Holds the constants used to define which data is sent in the TARDIS client update packet * */
public class DataUpdateValues {
    ...
    /** Update only data required for rendering, mainly the exterior model data, vortex name, etc * */
