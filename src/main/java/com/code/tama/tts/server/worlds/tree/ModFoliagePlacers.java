...
public class ModFoliagePlacers {
  ...
  public static final RegistryObject<FoliagePlacerType<GallifreyanFoliagePlacer>>
      GALLIFREYAN_OAK_PLACER =
          FOLIAGE_PLACERS.register(
              "gallifreyan_oak_foliage_placer",
              () -> new FoliagePlacerType<>(GallifreyanFoliagePlacer.CODEC));
