...
public class TPlacedFeatures {
	...
	public static void bootstrap(BootstapContext<PlacedFeature> context) {
		...
		register(context, CRATER_PLACED_KEY, configuredFeatures.getOrThrow(TConfiguredFeatures.CRATER_KEY),
				List.of(RarityFilter.onAverageOnceEvery(10), InSquarePlacement.spread(),
						HeightmapPlacement.onHeightmap(Heightmap.Types.WORLD_SURFACE_WG)));

		register(context, ZEITON_ORE_PLACED_KEY,
				configuredFeatures.getOrThrow(TConfiguredFeatures.OVERWORLD_ZEITON_ORE_KEY),
		...
		register(context, NETHER_ZEITON_ORE_PLACED_KEY,
				configuredFeatures.getOrThrow(TConfiguredFeatures.NETHER_ZEITON_ORE_KEY),
		...
		register(context, END_ZEITON_ORE_PLACED_KEY,
				configuredFeatures.getOrThrow(TConfiguredFeatures.END_ZEITON_ORE_KEY), MOrePlacement.commonOrePlacement(
		...
		register(context, GALLIFREYAN_OAK_PLACED_KEY,
				configuredFeatures.getOrThrow(TConfiguredFeatures.GALLIFREYAN_OAK_KEY), VegetationPlacements
