...
public class FlightTerminationProtocolRegistry {
  public static final Codec<FlightTerminationProtocol> CODEC =
      Codec.STRING.xmap(
          FlightTerminationProtocolRegistry::GetByName, FlightTerminationProtocol::getName);

  public static ArrayList<FlightTerminationProtocol> FLIGHT_TERMINATION_PROTOCOLS =
      new ArrayList<>();

  public static final FlightTerminationProtocol POLITE_TERMINUS =
      AddProtocol(
          FlightTerminationProtocol.builder()
  ...
  public static final FlightTerminationProtocol EMERGENCY_STOP =
      AddProtocol(
          FlightTerminationProtocol.builder()
              .name("emergency_stop")
  ...
  public static final FlightTerminationProtocol QUICK_STOP =
      AddProtocol(
          FlightTerminationProtocol.builder()
              .name("quick_stop")
  ...
  public static final FlightTerminationProtocol URGENT_STOP =
      AddProtocol(
          FlightTerminationProtocol.builder()
              .name("urgent_stop")
              .LandShakeAmount(0.2f)
