...
public class PlayerPosition {
  public static Codec<PlayerPosition> CODEC =
              ...
              instance
                  .group(
                      ...
                      Level.RESOURCE_KEY_CODEC
                          .fieldOf("level")
                          .forGetter(PlayerPosition::getLevelKey))
  ...
  @Builder.Default public ResourceKey<Level> levelKey = Level.OVERWORLD;
  ...
  public String toString() {
    return String.format(
        "%s/%s/%s/%s/%s/%s", YRot, Xrot, pos.x, pos.y, pos.z, levelKey.location().toString());
  }
