...
public abstract class AbstractMonitorBlock extends HorizontalDirectionalBlock
  ...
  public @NotNull InteractionResult use(
    ...
    switch (state.getValue(FACING)) {
      ...
      case SOUTH ->
          mouseX = mouseX; // <- Yes, I know this line seems redundant, but if I don't include it,
    ...
    UIComponentRegistry.UI_COMPONENTS
        ...
        .forEach(
            reg -> {
              if (reg.get().category.getID()
                      == ((AbstractMonitorTile) world.getBlockEntity(pos)).getCategoryID()
