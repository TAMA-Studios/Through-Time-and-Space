	...
	public static void Render(PoseStack stack, MultiBufferSource.BufferSource bufferSource) {
		...
		if (player.getMainHandItem().getItem() instanceof SonicItem sonicItem) {
			...
			Minecraft.getInstance().getItemRenderer().renderStatic(
					sonicItem.InteractionType.getIcon().getDefaultInstance(), ItemDisplayContext.GUI, 0xf000f0,
					OverlayTexture.NO_OVERLAY, stack, bufferSource, Minecraft.getInstance().level, 0);
