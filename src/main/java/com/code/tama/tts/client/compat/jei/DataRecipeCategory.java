...
public class DataRecipeCategory implements IRecipeCategory<DataRecipe> {
	...
	public DataRecipeCategory(IGuiHelper guiHelper) {
		...
		this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.world.item.Items.BOOK // replace with your recipe "book"/representative item
				));
	}
	...
	public void setRecipe(IRecipeLayoutBuilder builder, DataRecipe recipe, IFocusGroup recipeSlotsView) {
		// 6 items (inputs)
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.INPUT, 10, 10).addIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(recipe.item1)));
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.INPUT, 30, 10).addIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(recipe.item2)));
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.INPUT, 50, 10).addIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(recipe.item3)));
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.INPUT, 10, 30).addIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(recipe.item4)));
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.INPUT, 30, 30).addIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(recipe.item5)));
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.INPUT, 50, 30).addIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(recipe.item6)));

		// nozzle
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.INPUT, 80, 20).addIngredient(VanillaTypes.ITEM_STACK,
				new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(recipe.nozzle)));

		// output
		builder.addSlot(mezz.jei.api.recipe.RecipeIngredientRole.OUTPUT, 120, 20).addIngredient(VanillaTypes.ITEM_STACK,
