...
public class ClientSetup {
  ...
  public static final Lazy<KeyMapping> EXTERIOR_VIEW =
      Lazy.of(
          () ->
              new KeyMapping(
  ...
  public static void ClientSetup(FMLClientSetupEvent event) {
    event.enqueueWork(
        () ->
            ItemBlockRenderTypes.setRenderLayer(
                TTSBlocks.CHROMIUM_BLOCK.get(), RenderType.translucent()));
    ...
    ItemBlockRenderTypes.setRenderLayer(
        TTSBlocks.HUDOLIN_CONSOLE_BLOCK.get(), RenderType.translucent());
    ItemBlockRenderTypes.setRenderLayer(
        TTSBlocks.NESS_CONSOLE_BLOCK.get(), RenderType.translucent());
  ...
  public static void registerModels(EntityRenderersEvent.@NotNull RegisterLayerDefinitions event) {
    event.registerLayerDefinition(
        HartnellRotorModel.LAYER_LOCATION, HartnellRotorModel::createBodyLayer);
    event.registerLayerDefinition(
        ColinRichmondInteriorDoors.LAYER_LOCATION, ColinRichmondInteriorDoors::createBodyLayer);
    event.registerLayerDefinition(
        HudolinConsoleModel.LAYER_LOCATION, HudolinConsoleModel::createBodyLayer);
    event.registerLayerDefinition(
        NESSConsoleModel.LAYER_LOCATION, NESSConsoleModel::createBodyLayer);
  }
  ...
  public static void registerRenderers(EntityRenderersEvent.@NotNull RegisterRenderers event) {
    ...
    event.registerBlockEntityRenderer(
        TTSTileEntities.EXTERIOR_TILE.get(), TardisExteriorRenderer::new);
    event.registerBlockEntityRenderer(
        TTSTileEntities.HARTNELL_DOOR.get(), HartnellDoorRenderer::new);
    ...
    event.registerBlockEntityRenderer(
        HARTNELL_ROTOR.get(),
        context ->
            new HartnellRotorRenderer<>(
                context,
                new HartnellRotorModel<>(context.bakeLayer(HartnellRotorModel.LAYER_LOCATION))));
    event.registerBlockEntityRenderer(
        TTSTileEntities.CHAMELEON_CIRCUIT_PANEL.get(), ChameleonCircuitRenderer::new);
    event.registerBlockEntityRenderer(TTSTileEntities.MONITOR_TILE.get(), MonitorRenderer::new);
    event.registerBlockEntityRenderer(
        TTSTileEntities.CRT_MONITOR_TILE.get(), CRTMonitorRenderer::new);
    event.registerBlockEntityRenderer(
        TTSTileEntities.MONITOR_PANEL_TILE.get(), MonitorPanelRenderer::new);
    ...
    event.registerBlockEntityRenderer(
        TTSTileEntities.SONIC_CONFIGURATOR.get(), SonicConfiguratorRenderer::new);
  }
