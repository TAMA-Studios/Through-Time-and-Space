...
public class HartnellRotorModel<T extends HartnellRotorTile> extends HierarchicalModel<Entity>
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(32, 45)
						.addBox(-3.0F, -0.5F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 45)
						.addBox(-4.0F, -2.5F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 52)
						.addBox(-0.5F, -19.0F, -0.5F, 1.0F, 19.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(34, 52)
						.addBox(-2.5F, -4.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 54)
						.addBox(-3.5F, -5.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 54)
						.addBox(1.5F, -5.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(103, 1)
						.addBox(-6.5F, -13.0F, 0.0F, 13.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(108, -1)
						.addBox(0.0F, -18.0F, -5.0F, 0.0F, 5.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-6.5F, -5.5F, -6.5F, 13.0F, 0.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-6.5F, -13.0F, -6.5F, 13.0F, 0.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-6.5F, -5.5F, -6.5F, 13.0F, 0.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-6.5F, -13.0F, -6.5F, 13.0F, 0.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(1, 64)
						.addBox(-4.0F, 1.0F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 21.0F, 0.0F));

		PartDefinition glass = bone.addOrReplaceChild("glass", CubeListBuilder.create().texOffs(72, 1).addBox(-5.0F,
				-23.5F, 7.65F, 10.0F, 26.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.5F, 0.0F));

		PartDefinition cube_r1 = glass
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(72, 1).addBox(-5.0F, -26.0F, 7.65F, 10.0F, 26.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.0F, 1.0472F, 0.0F));

		PartDefinition cube_r2 = glass
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(72, 1).addBox(-5.0F, -26.0F, 7.65F, 10.0F, 26.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.0F, 2.0944F, 0.0F));

		PartDefinition cube_r3 = glass
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(72, 1).addBox(-5.0F, -26.0F, 7.65F, 10.0F, 26.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r4 = glass
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(72, 1).addBox(-5.0F, -26.0F, 7.65F, 10.0F, 26.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition cube_r5 = glass
		...
		PartDefinition bone3 = bone.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(34, 32)
						.addBox(-9.0F, -4.0F, -9.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(34, 32)
		...
		PartDefinition cube_r6 = bone3.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(64, 0).addBox(-0.5F, -16.801F, 6.75F, 1.0F, 17.0F, 1.0F,
		...
		PartDefinition bone5 = bone4.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(64, 0).addBox(-0.2F,
				-16.8F, -0.8F, 1.0F, 17.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offset(-0.8F, -0.001F, 7.55F));

		PartDefinition bone6 = bone5.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(60, 0)
						.addBox(-0.2F, -14.3F, -0.8F, 1.0F, 9.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(56, 0)
		...
		PartDefinition cube_r12 = bone6.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(65, 0)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)).texOffs(65, 0)
		...
		PartDefinition cube_r13 = bone6.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(68, 0)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)).texOffs(68, 0)
						.addBox(-0.5F, -8.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)),
		...
		PartDefinition bone11 = bone10.addOrReplaceChild("bone11", CubeListBuilder.create().texOffs(64, 0).addBox(-0.2F,
				-16.8F, -0.8F, 1.0F, 17.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offset(-0.8F, -0.001F, 7.55F));
		...
		PartDefinition cube_r14 = bone12.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(65, 0)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)).texOffs(65, 0)
						.addBox(-0.5F, -8.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)),
				PartPose.offsetAndRotation(0.3F, -6.0F, -0.3F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r15 = bone12.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(68, 0)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)).texOffs(68, 0)
						.addBox(-0.5F, -8.1F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)),
				PartPose.offsetAndRotation(-0.4F, -6.0F, -0.3F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition bone8 = bone7.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(64, 0).addBox(-0.2F,
				-16.8F, -0.8F, 1.0F, 17.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offset(-0.8F, -0.001F, 7.55F));
		...
		PartDefinition cube_r18 = bone2.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(1, 0)
						.addBox(-0.5F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(1, 0)
	...
	@Override
	public void setupAnim(@NotNull Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
			float netHeadYaw, float headPitch) {
	}

	public static class HartnellRotorAnimation {
		public static final AnimationDefinition LOOP = AnimationDefinition.Builder.withLength(4.0F).looping()
				.addAnimation("bone",
				...
				.addAnimation("bone",
						new AnimationChannel(AnimationChannel.Targets.POSITION,
								new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F),
										AnimationChannel.Interpolations.CATMULLROM),
								new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, -11.0F, 0.0F),
										AnimationChannel.Interpolations.CATMULLROM),
