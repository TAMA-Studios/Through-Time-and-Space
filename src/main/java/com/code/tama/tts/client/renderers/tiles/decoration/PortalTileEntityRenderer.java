        ...
        portal.getFBOContainer()
                .Render(
                        ...
                        (pose, botiSource) -> {
                            ...
                            BotiPortalModel.createBodyLayer().bakeRoot().render(pose, botiSource.getBuffer(RenderType.debugFilledBox()), 0xf000f0, OverlayTexture.NO_OVERLAY, 0, 0, 0, 0);
                            pose.popPose();
                        },
                        (pose, botiSource) -> {
                        },
