...
public class HudolinConsoleModel<T extends HudolinConsoleTile> extends HierarchicalModel<Entity>
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition panel_three_small_lights_r1 =
        root.addOrReplaceChild(
    ...
    PartDefinition console_plinth_one =
        root.addOrReplaceChild(
            "console_plinth_one", CubeListBuilder.create(), PartPose.offset(0.0F, -39.8F, 0.0F));

    PartDefinition corner_one_r1 =
        console_plinth_one.addOrReplaceChild(
            "corner_one_r1",
            CubeListBuilder.create()
                .texOffs(138, 82)
    ...
    PartDefinition cube_r4 =
        console_plinth_one.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 64)
                .addBox(
                    -4.9363F, -3.279F, -10.0349F, 10.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)),
    ...
    PartDefinition console_plinth_two =
        root.addOrReplaceChild(
            "console_plinth_two", CubeListBuilder.create(), PartPose.offset(0.0F, -24.7F, 0.0F));

    PartDefinition corner_one_r7 =
        console_plinth_two.addOrReplaceChild(
            "corner_one_r7",
            CubeListBuilder.create()
                .texOffs(86, 135)
    ...
    PartDefinition console_plinth_two2 =
        console_plinth_two.addOrReplaceChild(
            "console_plinth_two2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

    PartDefinition corner_one_r13 =
        console_plinth_two2.addOrReplaceChild(
            "corner_one_r13",
            CubeListBuilder.create()
                .texOffs(12, 136)
    ...
    PartDefinition console_plinth_three =
        root.addOrReplaceChild(
            "console_plinth_three", CubeListBuilder.create(), PartPose.offset(0.0F, -39.6F, 0.0F));

    PartDefinition corner_one_r19 =
        console_plinth_three.addOrReplaceChild(
            "corner_one_r19",
            CubeListBuilder.create()
                .texOffs(56, 135)
                .addBox(-0.45F, -1.0F, -9.0121F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.1F))
    ...
    PartDefinition under_console_struts =
        root.addOrReplaceChild(
            "under_console_struts",
            CubeListBuilder.create(),
            PartPose.offset(-0.075F, -0.3F, 0.0F));

    PartDefinition cube_r25 =
        under_console_struts.addOrReplaceChild(
            "cube_r25",
            CubeListBuilder.create()
                .texOffs(88, 116)
    ...
    PartDefinition console_corners =
        root.addOrReplaceChild(
            "console_corners", CubeListBuilder.create(), PartPose.offset(0.0F, 5.018F, -10.66F));

    PartDefinition corner_r1 =
        console_corners.addOrReplaceChild(
            "corner_r1",
            CubeListBuilder.create()
                .texOffs(112, 123)
    ...
    PartDefinition console_collar_one =
        root.addOrReplaceChild(
            "console_collar_one", CubeListBuilder.create(), PartPose.offset(0.0F, -27.5F, 0.0F));

    PartDefinition corner_one_r22 =
        console_collar_one.addOrReplaceChild(
            "corner_one_r22",
            CubeListBuilder.create()
                .texOffs(98, 137)
    ...
    PartDefinition console_collar_two =
        root.addOrReplaceChild(
            "console_collar_two",
            CubeListBuilder.create(),
            PartPose.offset(0.095F, -2.9F, -0.206F));

    PartDefinition corner_one_r25 =
        console_collar_two.addOrReplaceChild(
            "corner_one_r25",
            CubeListBuilder.create()
                .texOffs(136, 109)
    ...
    PartDefinition cube_r47 =
        bottom_rotor.addOrReplaceChild(
            "cube_r47",
            CubeListBuilder.create()
                .texOffs(96, 116)
    ...
    PartDefinition upper_console_one =
        root.addOrReplaceChild(
            "upper_console_one",
            CubeListBuilder.create(),
            PartPose.offsetAndRotation(-0.205F, -100.2F, -0.206F, 0.0F, 0.0F, -3.1416F));

    PartDefinition corner_one_r28 =
        upper_console_one.addOrReplaceChild(
            "corner_one_r28",
            CubeListBuilder.create()
                .texOffs(0, 137)
    ...
    PartDefinition upper_console_two =
        root.addOrReplaceChild(
            "upper_console_two",
            CubeListBuilder.create(),
            PartPose.offsetAndRotation(0.0F, -78.5F, 0.0F, 3.1416F, 0.0F, 0.0F));

    PartDefinition corner_one_r31 =
        upper_console_two.addOrReplaceChild(
            "corner_one_r31",
            CubeListBuilder.create()
                .texOffs(44, 137)
    ...
    PartDefinition ConsoleCollarTwo3 =
        root.addOrReplaceChild(
            "ConsoleCollarTwo3", CubeListBuilder.create(), PartPose.offset(0.095F, -2.9F, -0.206F));

    PartDefinition corner_one_r34 =
        ConsoleCollarTwo3.addOrReplaceChild(
            "corner_one_r34",
            CubeListBuilder.create()
                .texOffs(120, 128)
    ...
    PartDefinition ConsoleCollarOne6 =
        root.addOrReplaceChild(
            "ConsoleCollarOne6",
            CubeListBuilder.create(),
            PartPose.offsetAndRotation(0.0F, -74.5F, 0.0F, 3.1416F, 0.0F, 0.0F));

    PartDefinition corner_one_r37 =
        ConsoleCollarOne6.addOrReplaceChild(
            "corner_one_r37",
            CubeListBuilder.create()
                .texOffs(82, 131)
    ...
    PartDefinition bone5 =
        root.addOrReplaceChild(
            "bone5", CubeListBuilder.create(), PartPose.offset(1.95F, -23.45F, -0.8F));
    ...
    PartDefinition lights_right_r1 =
    ...
    PartDefinition crank_lever =
        root.addOrReplaceChild(
            "crank_lever",
            CubeListBuilder.create(),
            PartPose.offset(4.5827F, -19.6656F, -13.8459F));

    PartDefinition base_r1 =
        crank_lever.addOrReplaceChild(
            "base_r1",
            CubeListBuilder.create()
                .texOffs(134, 63)
    ...
    PartDefinition buttons =
        root.addOrReplaceChild(
            "buttons", CubeListBuilder.create(), PartPose.offset(1.115F, -18.0429F, -17.24F));

    PartDefinition base_r3 =
        buttons.addOrReplaceChild(
            "base_r3",
            CubeListBuilder.create()
                .texOffs(94, 133)
    ...
    PartDefinition control_two =
        root.addOrReplaceChild(
            "control_two", CubeListBuilder.create(), PartPose.offset(1.0F, -22.7F, -0.8F));

    PartDefinition cube_r79 =
        control_two.addOrReplaceChild(
            "cube_r79",
            CubeListBuilder.create()
                .texOffs(50, 124)
    ...
    PartDefinition control_three =
        root.addOrReplaceChild(
            "control_three", CubeListBuilder.create(), PartPose.offset(1.0F, -22.7F, -0.8F));

    PartDefinition cube_r82 =
        control_three.addOrReplaceChild(
            "cube_r82",
            CubeListBuilder.create()
                .texOffs(104, 105)
    ...
    PartDefinition lamp =
        root.addOrReplaceChild(
            "lamp", CubeListBuilder.create(), PartPose.offset(-8.9458F, -22.5354F, 8.9259F));

    PartDefinition cube_r92 =
        lamp.addOrReplaceChild(
            "cube_r92",
            CubeListBuilder.create()
                .texOffs(42, 132)
    ...
    PartDefinition lever_section_2_r1 =
    ...
    PartDefinition x =
        root.addOrReplaceChild(
            "x", CubeListBuilder.create(), PartPose.offset(12.3022F, -19.5876F, -6.1706F));
    ...
    PartDefinition y =
        root.addOrReplaceChild(
            "y", CubeListBuilder.create(), PartPose.offset(12.3022F, -19.5876F, -6.1706F));
    ...
    PartDefinition z =
        root.addOrReplaceChild(
            "z", CubeListBuilder.create(), PartPose.offset(12.3022F, -19.5876F, -6.1706F));
    ...
    PartDefinition increment =
        root.addOrReplaceChild(
            "increment", CubeListBuilder.create(), PartPose.offset(12.3022F, -19.5876F, -6.1706F));

    PartDefinition increment_r1 =
        increment.addOrReplaceChild(
            "increment_r1",
            CubeListBuilder.create()
                .texOffs(138, 70)
    ...
    PartDefinition randomiser =
        root.addOrReplaceChild(
            "randomiser", CubeListBuilder.create(), PartPose.offset(1.95F, -21.45F, -0.8F));

    PartDefinition randomiser_r1 =
        randomiser.addOrReplaceChild(
            "randomiser_r1",
            CubeListBuilder.create()
                .texOffs(138, 127)
    ...
    PartDefinition communicator =
        root.addOrReplaceChild(
            "communicator", CubeListBuilder.create(), PartPose.offset(-0.075F, -19.0F, -1.2F));

    PartDefinition communicator_r1 =
        communicator.addOrReplaceChild(
            "communicator_r1",
            CubeListBuilder.create()
                .texOffs(54, 120)
    ...
    PartDefinition refuller =
        root.addOrReplaceChild(
            "refuller", CubeListBuilder.create(), PartPose.offset(-12.7164F, -16.8731F, 7.3501F));

    PartDefinition refuller_r1 =
        refuller.addOrReplaceChild(
            "refuller_r1",
            CubeListBuilder.create()
                .texOffs(104, 41)
    ...
    PartDefinition door_control =
        root.addOrReplaceChild(
            "door_control", CubeListBuilder.create(), PartPose.offset(-9.9F, -20.3F, 5.775F));

    PartDefinition door_control_r1 =
        door_control.addOrReplaceChild(
            "door_control_r1",
            CubeListBuilder.create()
                .texOffs(140, 12)
    ...
    PartDefinition dimension_changer =
        root.addOrReplaceChild(
            "dimension_changer",
            CubeListBuilder.create(),
    ...
    PartDefinition exterior_facing =
        root.addOrReplaceChild(
            "exterior_facing", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

    PartDefinition exterior_facing_r1 =
        exterior_facing.addOrReplaceChild(
            "exterior_facing_r1",
            CubeListBuilder.create()
                .texOffs(128, 167)
    ...
    PartDefinition fast_return_switch =
        root.addOrReplaceChild(
            "fast_return_switch", CubeListBuilder.create(), PartPose.offset(1.95F, -21.45F, -0.8F));

    PartDefinition fast_return_switch_r1 =
        fast_return_switch.addOrReplaceChild(
