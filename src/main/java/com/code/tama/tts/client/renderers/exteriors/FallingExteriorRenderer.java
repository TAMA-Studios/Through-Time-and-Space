...
public class FallingExteriorRenderer extends EntityRenderer<FallingExteriorEntity> {
	...
	@Override
	public void render(FallingExteriorEntity entity, float yaw, float partialTicks, PoseStack stack,
			MultiBufferSource buffer, int light) {
		if (entity.getTileData() != null) {
			if (this.entity == null) {
				this.entity = new ExteriorTile(BlockPos.ZERO, entity.getBlockState());
