...
public class TTSPonderPlugin implements PonderPlugin {
	...
	public void registerSharedText(SharedTextRegistrationHelper helper) {
		...
		helper.registerSharedText("behaviour_modify_value_panel",
				"This behaviour can be modified using the value panel");
		helper.registerSharedText("storage_on_contraption",
	...
	public void indexExclusions(IndexExclusionHelper helper) {
		// helper.excludeBlockVariants(ValveHandleBlock.class,
		// AllBlocks.COPPER_VALVE_HANDLE.get());
		// helper.excludeBlockVariants(PostboxBlock.class,
		// AllBlocks.PACKAGE_POSTBOXES.get(DyeColor.WHITE).get());
		// helper.excludeBlockVariants(TableClothBlock.class,
