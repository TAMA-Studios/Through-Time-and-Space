...
//        ShadersUtil.CHROMIUM_SHADER.apply();
        ...
        // You'll need to access RenderSystem.getProjectionMatrix(), RenderSystem.getModelViewMatrix(), etc.
        // However, with custom shaders, you're responsible for setting up matrices if you want them.
        // For this simple example, we'll rely on the default matrix setup provided by Minecraft's rendering context.
        ...
        // You'd need to create a `VertexConsumer` and add vertices with position, color, UV, normal, light.
