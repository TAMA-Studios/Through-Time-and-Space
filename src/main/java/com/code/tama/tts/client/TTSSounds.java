...
public class TTSSounds {
  ...
  public static final RegistryObject<SoundEvent> KEYBOARD_PRESS_01 =
      registerSound("keyboard_press_01");

  public static final RegistryObject<SoundEvent> TARDIS_FLIGHT_LOOP =
      registerSound("tardis_flight_loop");
