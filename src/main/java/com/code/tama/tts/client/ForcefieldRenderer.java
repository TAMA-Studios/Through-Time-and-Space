...
//        VertexConsumer consumer = buffer.getBuffer(RenderType.debugQuads());
        ...
        for (int lat = 0; lat < LAT_SEGMENTS; lat++) {
            ...
            for (int lon = 0; lon < LONG_SEGMENTS; lon++) {
                ...
                // draw the quad
                drawQuad(matrix, builder, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, FastColor.ARGB32.color(255, 0, 0, 255));
            }
        }
    ...
    private static void drawQuad(PoseStack.Pose matrix, BufferBuilder builder,
        ...
        for (float[] v : verts) {
            ...
            builder.vertex(matrix.pose(), v[0], v[1], v[2])
                    .color(r, g, b, a)
