...
public class MonitorPanelRenderer extends AbstractMonitorRenderer<MonitorPanelTile> {
    ...
    //
    // @Override
    // public void render(@NotNull MonitorTile monitor, float partialTicks, @NotNull
    // PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int
    ...
    // poseStack.last().pose(), bufferSource, Font.DisplayMode.SEE_THROUGH, 0,
    // combinedLight);
    //
    ...
    // }
    //
    // private void renderRotatingImage(MonitorTile monitor, PoseStack poseStack,
    // MultiBufferSource bufferSource, int combinedLight) {
    // ResourceLocation texture = new ResourceLocation(ttsMod.MODID,
