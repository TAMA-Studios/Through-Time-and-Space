...
public class FaultLocatorRenderer implements BlockEntityRenderer<FaultLocatorTile> {
	...
	public static void RenderText(String text, PoseStack stack, MultiBufferSource builder, int x, int y) {
		Minecraft.getInstance().font.drawInBatch(Component.literal(text), x, y, 0xFFFFFF, false, stack.last().pose(),
				builder, Font.DisplayMode.NORMAL, 0, 0xf000f0);
	}
}
