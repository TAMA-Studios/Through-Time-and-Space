...
public class HartnellDoorRenderer implements BlockEntityRenderer<HartnellDoorTile>, IUseJavaJSON {
	...
	@Override
	public void render(@NotNull HartnellDoorTile example, float partialTicks, @NotNull PoseStack poseStack,
		...
		parsed.getModelInfo().getModel().renderToBuffer(poseStack, bufferSource.getBuffer(this.getRenderType()),
