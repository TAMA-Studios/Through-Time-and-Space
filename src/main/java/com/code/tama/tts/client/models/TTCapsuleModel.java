...
public class TTCapsuleModel<T extends ExteriorTile> extends HierarchicalExteriorModel {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(new ResourceLocation(TTSMod.MODID, "ttcapsulemodel"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition base = partdefinition.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(1, 0)
                        .addBox(-8.0F, -35.0F, -8.0F, 1.0F, 32.0F, 16.0F, new CubeDeformation(0.0F))
                        .texOffs(137, 0)
                        .mirror()
                        .addBox(7.0F, -35.0F, -8.0F, 1.0F, 32.0F, 16.0F, new CubeDeformation(0.0F))
                        .mirror(false)
                        .texOffs(0, 48)
                        .addBox(-9.0F, -3.0F, -9.0F, 18.0F, 4.0F, 18.0F, new CubeDeformation(0.0F))
                        .texOffs(64, 0)
                        .addBox(-9.0F, -39.0F, -9.0F, 18.0F, 4.0F, 18.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition cube_r1 = base.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(103, 22)
                        .addBox(-8.0F, -32.0F, -9.0F, 1.0F, 32.0F, 16.0F, new CubeDeformation(0.0F)),
        ...
        PartDefinition RightDoor = partdefinition.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(1, 102)
                        .addBox(0.0F, -32.0F, 0.0F, 7.0F, 32.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(-7.0F, 20.0F, -7.0F));

        PartDefinition LeftDoor = partdefinition.addOrReplaceChild(
                "LeftDoor",
                CubeListBuilder.create()
                        .texOffs(15, 69)
                        .addBox(-7.0F, -32.0F, 0.0F, 7.0F, 32.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(7.0F, 20.0F, -7.0F));
