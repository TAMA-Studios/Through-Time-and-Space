...
public class KeyboardHandler {
    public static final Lazy<KeyMapping> SONIC_MODE = Lazy.of(() -> new KeyMapping("tts.keybinds.sonic_mode", InputConstants.Type.KEYSYM, InputConstants.KEY_G, "tts.keybinds.catagory"));
