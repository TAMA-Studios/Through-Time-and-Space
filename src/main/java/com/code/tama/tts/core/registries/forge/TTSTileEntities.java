...
public class TTSTileEntities {
	...
	public static final BlockEntityEntry<BotiWindowTile> BOTI_WINDOW = registrate()
	...
	public static final BlockEntityEntry<HartnellDoorTile> HARTNELL_DOOR = registrate()
			.blockEntity("hartnell_door", HartnellDoorTile::new).validBlocks(TTSBlocks.HARTNELL_DOOR)
			.renderer(() -> HartnellDoorRenderer::new).register();
