...
import com.code.tama.tts.core.worlds.TPlacedFeatures;
...
public class TBiomes {
	...
	public static Biome GallifreyanDesertBiome(BootstapContext<Biome> context) {
		...
		return new Biome.BiomeBuilder().hasPrecipitation(false).downfall(0.0f).temperature(0.8f)
				.generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
				.specialEffects((new BiomeSpecialEffects.Builder()).waterColor(0xE2a879).waterFogColor(0xE2A879)
						.skyColor(0xE2a879).grassColorOverride(0xA24507).foliageColorOverride(0xd203fc)
						.fogColor(0xE2a879).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS)
