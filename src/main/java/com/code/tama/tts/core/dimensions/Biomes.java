/* (C) TAMA Studios 2025 */
package com.code.tama.tts.core.dimensions;
...
public class Biomes {
	...
	public static final RegistryObject<Codec<? extends ChunkGenerator>> TARDIS_NATURAL_CHUNK_GENERATOR = CHUNK_GENERATORS
