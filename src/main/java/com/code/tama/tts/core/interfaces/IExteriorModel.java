...
public interface IExteriorModel<T extends BlockEntity> {
     ...
     * the ArrayList will be called for getting the rotation of the door at the specified values, in the default implementation, the door rotations for the right door are as follows: <br />
     * 0 doors open - 0f <br />
     * 1 doors open - Math.toRadians(75) <br />
     * 2 doors open - Math.toRadians(75) <br />
     * @return A map containing each rotation value for both left and right doors <br />
     */
