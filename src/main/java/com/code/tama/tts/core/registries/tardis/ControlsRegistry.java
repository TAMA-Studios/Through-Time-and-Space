...
public class ControlsRegistry {
    ...
    public static final RegistryObject<SimplestControl> ASTRAL_MAP = CONTROLS.register("astral_map",
            () -> new SimplestControl("astral_map",
                    tardis -> {
                        if (tardis.GetLevel().isClientSide)
                            Minecraft.getInstance().setScreen(new AstralMapScreen(tardis.GetCurrentLevel(), null, tardis.GetNavigationalData().getDestination()));
                    },
                    tardis -> {
                        if (tardis.GetLevel().isClientSide)
                            Minecraft.getInstance().setScreen(new AstralMapScreen(tardis.GetCurrentLevel(), null, tardis.GetNavigationalData().getDestination()));
