/* (C) TAMA Studios 2025 */
package com.code.tama.tts.core.datagen.loot;
...
public class DataBlockLootTables extends BlockLootSubProvider {
	...
	protected void generate() {
		...
		// block -> createCopperLikeOreDrops(TTSBlocks.ZEITON_ORE.get(),
		// TTSItems.RAW_ZEITON.get()));
		// this.add(TTSBlocks.DEEPSLATE_ZEITON_ORE.get(),
		// block -> createCopperLikeOreDrops(TTSBlocks.DEEPSLATE_ZEITON_ORE.get(),
		// TTSItems.RAW_ZEITON.get()));
		// this.add(TTSBlocks.NETHER_ZEITON_ORE.get(),
		// block -> createCopperLikeOreDrops(TTSBlocks.NETHER_ZEITON_ORE.get(),
		// TTSItems.RAW_ZEITON.get()));
		// this.add(TTSBlocks.END_STONE_ZEITON_ORE.get(),
		// block -> createCopperLikeOreDrops(TTSBlocks.END_STONE_ZEITON_ORE.get(),
		// TTSItems.RAW_ZEITON.get()));
		//
		...
		// this.add(TTSBlocks.GALLIFREYAN_OAK_DOOR.get(), block ->
		// createDoorTable(TTSBlocks.GALLIFREYAN_OAK_DOOR.get()));
		//
		...
		// block -> createLeavesDrops(block, TTSBlocks.GALLIFREYAN_SAPLING.get(),
		...
		// this.dropOther(TTSBlocks.HARTNELL_DOOR_PLACEHOLDER.get(),
		// TTSBlocks.HARTNELL_DOOR.get());
