...
public class ModBlockLootTables extends BlockLootSubProvider {
  ...
  protected void generate() {
    ...
    this.add(
        ...
        block ->
            createCopperLikeOreDrops(
                TTSBlocks.DEEPSLATE_ZEITON_ORE.get(), TTSItems.RAW_ZEITON.get()));
    this.add(
        TTSBlocks.NETHER_ZEITON_ORE.get(),
        block ->
            createCopperLikeOreDrops(TTSBlocks.NETHER_ZEITON_ORE.get(), TTSItems.RAW_ZEITON.get()));
    this.add(
        TTSBlocks.END_STONE_ZEITON_ORE.get(),
        block ->
            createCopperLikeOreDrops(
                TTSBlocks.END_STONE_ZEITON_ORE.get(), TTSItems.RAW_ZEITON.get()));
    ...
    this.add(
        TTSBlocks.GALLIFREYAN_OAK_DOOR.get(),
    ...
    this.add(
        ...
        block ->
            createLeavesDrops(
                block, TTSBlocks.GALLIFREYAN_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
