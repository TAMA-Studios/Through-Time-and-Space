...
public class MBlockStateProvider extends BlockStateProvider {
    ...
    public void trapdoorBlockWithRenderType(
        ...
        try {
            ...
            ModelFile bottom = orientable
                    ? models().trapdoorOrientableBottom(baseName + "_bottom", texture)
                            .renderType(renderType)
            ...
            ModelFile open = orientable
                    ? models().trapdoorOrientableOpen(baseName + "_open", texture)
                            .renderType(renderType)
    ...
    private void SpecialBlockItem(RegistryObject<? extends Block> blockRegistryObject) {
        simpleBlockItem(
                ...
                new ModelFile.UncheckedModelFile(MODID + ":block/"
