...
public class DataBlockTagGenerator extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider pProvider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(TTSBlocks.ZEITON_BLOCK.get(), TTSBlocks.RAW_ZEITON_BLOCK.get(),
				TTSBlocks.ZEITON_ORE.get(), TTSBlocks.DEEPSLATE_ZEITON_ORE.get(), TTSBlocks.NETHER_ZEITON_ORE.get(),
