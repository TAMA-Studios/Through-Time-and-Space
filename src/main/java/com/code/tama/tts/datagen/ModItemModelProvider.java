...
public class ModItemModelProvider extends ItemModelProvider {
  ...
  protected void registerModels() {
    ...
    for (RegistryObject<Block> block : TTSBlocks.BLOCKS.getEntries()) {
      ResourceLocation outputLoc =
          extendWithFolder(new ResourceLocation(modid, ("item/" + block.getId().getPath())));
      if (!this.generatedModels.containsValue(outputLoc)) simplestBlockItem(block);
    }
  }
  ...
  private ItemModelBuilder saplingItem(RegistryObject<Block> item) {
    return withExistingParent(item.getId().getPath(), new ResourceLocation("item/generated"))
        .texture("layer0", new ResourceLocation(MODID, "block/" + item.getId().getPath()));
  }
  ...
  public void evenSimplerBlockItem(RegistryObject<Block> block) {
    this.withExistingParent(
        MODID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
    ...
    this.withExistingParent(
        ...
        .texture(
            ...
            new ResourceLocation(
                MODID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
  }
