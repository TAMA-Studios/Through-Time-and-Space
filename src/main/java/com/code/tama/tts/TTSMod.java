...
import static com.code.tama.tts.core.registries.forge.TTSCreativeTabs.CREATIVE_MODE_TABS;
...
import com.code.tama.tts.core.items.tabs.Decorational;
import com.code.tama.tts.core.items.tabs.DimensionalTab;
import com.code.tama.tts.core.items.tabs.MainTab;
import com.code.tama.tts.core.items.tabs.SOV;
import com.code.tama.tts.core.loots.TTSLootModifiers;
import com.code.tama.tts.core.networking.Networking;
import com.code.tama.tts.core.registries.TTSRegistrate;
import com.code.tama.tts.core.registries.forge.*;
	...
	public static TTSRegistrate registrate() {
		if (!STACK_WALKER.getCallerClass().getPackageName().startsWith("com.code.tama"))
			throw new UnsupportedOperationException(
					"GET OFF MY LAWN! (Don't use TTS's Registrate instance, make your own.");
		return REGISTRATE;
	}
}
